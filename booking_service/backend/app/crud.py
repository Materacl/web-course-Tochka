...
from app.models import User, Film, Session as FilmSession, Seat, Booking, Reservation, CinemaHall
from app.schemas import UserCreate, FilmCreate, SessionCreate, SeatCreate, BookingCreate, ReservationCreate, \
    CinemaHallCreate
...
def create_reservation(db: Session, reservation: ReservationCreate, booking_id: int):
    db_reservation = Reservation(**reservation.dict(), booking_id=booking_id)
